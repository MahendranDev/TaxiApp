...
class OTPStackView: UIStackView {
   ...
   //Colors
   let inactiveFieldBorderColor = UIColor.systemGray5
   let textBackgroundColor =  UIColor(red: 130, green: 130, blue: 130, alpha: 1.0)// UIColor(white: 1, alpha: 0.5)
   let activeFieldBorderColor =  UIColor(red: 130, green: 130, blue: 130, alpha: 1.0)// UIColor.white
   ...
   private final func setupTextField(_ textField: OTPTextField) {
      ...
      textField.widthAnchor.constraint(equalToConstant: 65).isActive = true
      textField.backgroundColor = inactiveFieldBorderColor
      textField.textAlignment = .center
      textField.adjustsFontSizeToFitWidth = false
      textField.font = UIFont(name: "PublicSans-Medium", size: 20)
